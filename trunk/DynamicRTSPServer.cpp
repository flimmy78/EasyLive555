...
static ServerMediaSession* createNewSMS(UsageEnvironment& env,
	...
	if (strcmp(fileName, "TypeCodec=H.265") == 0) {
        ...
        LiveStreamMediaSource* H265InputDevice = LiveStreamMediaSource::createNew(env);
        ...
        sms->addSubsession(ADTSAudioLiveServerMediaSubsession::createNew(env, *H265InputDevice,reuseSource));
	}
