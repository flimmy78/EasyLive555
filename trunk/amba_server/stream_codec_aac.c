...
//=============================================================================
stream_codec_desc_t     stream_codec_aac_desc =
{
    NULL,                   // struct stream_codec_desc    *next;
    "stream codec AAC",     // const char                  *name;
    AMP_FORMAT_MID_AAC,     // AMP_FORMAT_MID_e            codec_id;
    aac_parse_frame_header, // int     (*parse_specific_info)(stream_codec_param_t *pCodec_param, void *extra);
    NULL,                   // int     (*destroy_specific_info)(stream_codec_param_t *pCodec_param, void *extra);
    aac_frame_pre_proc,     // int     (*pre_proc)(stream_codec_param_t *pCodec_param, void *extra);
