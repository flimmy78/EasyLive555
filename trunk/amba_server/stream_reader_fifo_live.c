    ...
    do{
        ...
        switch( track_type )
        {
            ...
            case AMBA_NETFIFO_MEDIA_TRACK_TYPE_VIDEO:
                ...
                pVfifo_info->u.video.gop_size         = (unsigned int)pTrack_info->Info.Video.nGOPSize;
    ...
    stream_fifo_param_t *pfifo_param)
{
    ...
    pBits_desc = (AMBA_NETFIFO_BITS_DESC_s*)pfifo_param->pExtra_data;
...
//=============================================================================
stream_fifo_desc_t   amba_stream_live_desc =
{
    NULL,                   // struct stream_fifo_fifo_desc  *next;
    "live stream",          // const char          *name;
    STREAM_TYPE_LIVE,       // unsigned int        stream_type;
    live_fifo_create,       // int     (*vfifo_create)(stream_fifo_fifo_param_t *pfifo_info);
    live_fifo_destroy,      // int     (*vfifo_destroy)(stream_fifo_fifo_param_t *pfifo_info);
};
